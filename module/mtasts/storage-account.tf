resource "azurerm_storage_account" "mta-sts" {
  ...
  network_rules {
    ...
    ip_rules       = concat(data.azurerm_network_service_tags.AzureFrontDoor-BackEnd.ipv4_cidrs, data.azurerm_network_service_tags.AzureFrontDoor-BackEnd.ipv6_cidrs)
  }
  blob_properties {
